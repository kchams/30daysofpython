...
- The reduce function is like map and filter it takes two parameters, a function and an iterable.
...
countries_contain_land = filter(contain_land, countries)
...
six_more_countries = filter(six_more_characters, countries)
print(list(six_more_countries))

#7. Use filter to filter out countries starting with an 'E'
def start_with(country):
    return country.startswith('E')

countries_start_with = filter(start_with, countries)
print(list(countries_start_with))
...
more_list_iterators = map(square, numbers)
filter_even_numbers =filter(is_even, more_list_iterators)
numbers_sums = reduce(sum_nums, filter_even_numbers)
print(numbers_sums)
...
def get_string_lists(string1, string2):
    return f'{string1} {string2}'

string_list = reduce(get_string_lists, countries)
print(string_list)

#10. Use reduce to sum all the numbers in the numbers list.
def sum_all_number(num1, num2):
    return int(num1) + int(num2)

sum_numbers = reduce(sum_all_number, numbers)
print(sum_numbers)

#11. Use reduce to concatenate all the countries and to produce this sentence:
# Estonia, Finland, Sweden, Denmark, Norway, and Iceland are north European countries
def concat_all_countries(country1, country2):
    return f'{country1}, and {country2}' + ' are north European countries'

concat_countries = reduce(concat_all_countries, countries)
...
sorted_by_name = sorted(country, key=lambda item: item[0])
